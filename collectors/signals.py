    ...
    try:
        ...
        if stables and btc is not None:
            ...
            out.append(sig(80, f"BTC perp funding annualizes at {btc*100:.1f}% on Lighter. "
                          ...
                          "yield-bearing-collateral", "carry"))
    ...
    try:
        ...
        if live:
            ...
            out.append(sig(75, f"{v} carries ${b['oi']:,.0f} of open interest across {b['n']} "
                          ...
                          "spot-collateral-collapsing-basis", "carry"))
    except Exception as e:
...
def run():
    ...
    print("Pick a signal, pick ONE question under it, send it cold with no mention")
    print("of posting. The questions are templates; the choice is the input.\n")
